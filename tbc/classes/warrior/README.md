...
- Await the Warrior's talent build, stance plan, rotation, content, and targeting needs before choosing macros.

### Deliberately not macroed

- No generic Warrior rotation, stance sequence, weapon swap, or talent abilities are inferred without player context.
...
No imported Warrior source material yet.
